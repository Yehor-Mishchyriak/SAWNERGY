...
# Quality control
The repository includes a `tests/` suite with 52 tests invoked via `pytest` covering storage helpers, walk sampling, embedding utilities, and math helpers.
